    ...
    <ClientPageTransition>
      <div className="space-y-6">
        <div className="text-center space-y-2">
          <h2 className="text-2xl font-semibold">Excel to JSON Converter</h2>
          <p className="text-gray-400">Convert Excel spreadsheets to JSON format</p>
        </div>
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <div className="space-y-2">
                <div className="w-full h-48 bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-lg px-4 py-2 flex items-center justify-center">
                  <label className="cursor-pointer flex flex-col items-center space-y-2 text-gray-300 hover:text-gray-200">
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-lg p-4">
            ...
            <ul className="text-sm text-gray-400 space-y-1">
              ...
              <li>• The first sheet will be converted to JSON</li>
